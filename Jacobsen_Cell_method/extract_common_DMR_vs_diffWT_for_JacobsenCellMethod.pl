#!/usr/bin/perl -w
#extract_commod_DMR_for_JacobsenCellMethod.pl
# Mar 25: Now I have two set DMR list (vs_SH_col_pool and vs_JKZ131_Kaust)
# to extract DMRs both exits in the two set
...
my $usage = "$0 \n <indir1> <vs_label1> <indir2> <vs_label2> <outdir>\n\n";
...
foreach my $type (@types){
	foreach my $hyp ( @hyps ){
		my @files1 = get_files ( $indir1, $type, $hyp );
		my @files2 = get_files ( $indir2, $type, $hyp );
