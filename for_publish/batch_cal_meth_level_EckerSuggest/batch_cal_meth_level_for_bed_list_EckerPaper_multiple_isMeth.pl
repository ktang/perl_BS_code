...
my $script = "/Users/tang58/Kai_BS/for_publish/batch_cal_meth_level_EckerSuggest/cal_meth_level_for_bed_list_EckerPaper_multiple_isMeth.pl";
die unless (-e $script);
