# R --slave --vanilla --args  png_pre indir < /Users/tang58/Kai_BS/for_publish/10_gene_TE_bin_files_R_cmd_TE_command_input.r
...
par(xpd=NA)
################
legend(-280, -2.5,legend= x_lables , col = cols, lwd = 3, bty = "n",  cex = 0.7
,   ncol = length,
