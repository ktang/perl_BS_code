...
# my $output = File::Spec->catfile($outdir, $outpre . "_DMRs_number_WinSize" . $bin_size . "_sliding" . $sliding_size . "_" . $postfix .".txt");
 my $output = File::Spec->catfile($outdir, $outpre . "_number_WinSize" . $bin_size . "_sliding" . $sliding_size .".txt");
