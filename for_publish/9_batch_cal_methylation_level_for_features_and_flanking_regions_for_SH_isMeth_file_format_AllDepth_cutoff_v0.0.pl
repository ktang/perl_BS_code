...
my $script = "/Users/tang58/Kai_BS/for_publish/9_beCalled_cal_methylation_level_for_features_and_flanking_regions_for_SH_isMeth_file_format_AllDepth_cutoff_v0.0.pl";
