...
while(<IN>){
	...
	$CG_diff  = $a[$CG_index]  if( $a[$CG_index] ne "NA" ) ;# - $a[$CG_index2]  if( $a[$CG_index] ne "NA" );
	$CHG_diff = $a[$CHG_index] if($a[$CHG_index] ne "NA" ) ;# - $a[$CHG_index2] if($a[$CHG_index] ne "NA" );
	$CHH_diff = $a[$CHH_index] if($a[$CHH_index] ne "NA")  ;#- $a[$CHH_index2] if($a[$CHH_index] ne "NA");
