...
print OUT join("\t", ("itr_num", "window_size", "allowed_gap", "cutoff_initial_query", "cutoff_report", "hyper_DMR","total_bp_hyper","bp_per_hyper", "hypo_DMC", "total_bp_hypo", "bp_per_hyp", "overlap_num", "percentage_vs_hyper" )), "\n";
...
#print OUT join("\t", ("itr_num", "window_size", "allowed_gap", "cutoff_initial_query", "cutoff_report", "hyper_DMR", "hypo_DMC", "overlap_num", "percentage_vs_hyper" )), "\n";
	...
	print OUT join("\t", ($j+1,$window_size, $allowed_gap, $cutoff_for_small_region, $cutoff_for_merged_region, $num_hyper, $bp_hyper,$bp_per_hyper, $num_hypo, $bp_hypo,$bp_per_hypo, $overlap_num, $per )), "\n";
	
#	if($debug){
#		output_hyper(\@line_hyper, "hyper_debug_v2.0.txt");
#		output_hypo(\@line_hypo,  "hypo_debug_v2.0.txt");
#	}
