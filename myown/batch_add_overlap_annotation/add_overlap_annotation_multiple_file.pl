...
#my $script = "/Users/tang58/misc/Xingang_Wang/paper/58-2_ibm2/diff_exp_gene_with_high_promoter/src/extract_expression_level_from_cufflinks_1to1.pl";
...
my $usage = "$0 \n <promoter_list> <indir> <outdir> <output_name>\n\n";
