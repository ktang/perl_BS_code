...
my $usage = "$0\n <input> <outdir> <pre> <p_value> <dep> <anchor_cutoff> <final_cutoff>\n\n";
...
#Nov 30 changed:
my $postfix = "P". $p_flag ."_reduced_boundary2_dep" . $dep . "_WinSize" . $bin_size . "_sliding" . $sliding_size .  "_gap" . $allowed_gap . "_initialCutoff" . $cutoff_for_small_region . "_reportCutoff" . $cutoff_for_merged_region . ".txt";
