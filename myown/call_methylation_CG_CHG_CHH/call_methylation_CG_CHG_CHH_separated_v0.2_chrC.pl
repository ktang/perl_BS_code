...
my $cutoff_file = File::Spec->catfile($outdir,$pre. "_chrC_error_cutoff_separately_called.txt");
my $output = 	  File::Spec->catfile($outdir,$pre. "_isMeth_chrC_error_separately_called.txt");
