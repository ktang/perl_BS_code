...
my $cutoff_file = File::Spec->catfile($outdir,$pre. "_chrM_error_cutoff_separately_called.txt");
my $output = 	  File::Spec->catfile($outdir,$pre. "_isMeth_chrM_error_separately_called.txt");
