...
my  $usage = "$0 <WT> <feature_bin_num> <flaking_bp> <flaking_bin_num> <input_list> <outdir> <outpre>";
...
my $output = File::Spec->catfile($outdir, $outpre . "_in_highWT_" . "binNum" . $feature_bin_num . "_flaking" . $flaking_bp . "bp_binNum" . $flaking_bin_num . ".txt");
