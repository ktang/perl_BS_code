...
print STDERR "input is subset of isMeth file\n\n";
...
print STDERR "depth >= $min_depth and input should be remove-dupl results subset \n\n\n";
...
my $output = File::Spec->catfile($outdir,$WT_pre ."_vs_". $mut_pre . "_diff_bases_P" . $p_cutoff . "_SubSetMinDep" . $min_depth . ".txt");
