...
print STDERR "1: start read isMeth files...\t";
...
print STDERR "2: start cal p-value...\t";
...
print STDERR "3: read adj p-value...\t";
...
print STDERR "4: merge_raw_list...\n";

print STDERR "hyper raw list\n";
merge_list(\@raw_list_hyper, \@list_hyper_merged, $allowed_gap);

print STDERR "hypo raw list\n";
...
my (@hyper_list_border, @hypo_list_border);

my (%region_in_hyper, %region_in_hypo);

print STDERR "5: adjust border and filter DMC...\n";

print STDERR "hyper_list_";
...
#my ($hyper_file, $hypo_file, $region_in_list_ref, $mC_list_ref, 	$dep_list_ref, $percentage_list_ref) = @_;
