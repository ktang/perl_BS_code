...
if($debug){
#	$colA_forw = "/home/becky/Software/src/10000_forw.txt";
#	$colA_rev  = "/home/becky/Software/src/10000_rev.txt"; 
...
my $output = File::Spec->catfile($dir,"colA_vs_". $pre . "_diff_bases_P" . $p_cutoff . "_depth_" . $min_depth . "_" . $max_depth . "_both.txt");
