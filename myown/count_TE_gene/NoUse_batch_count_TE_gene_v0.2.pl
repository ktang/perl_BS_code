...
my $script = "/Users/tang58/Kai_BS/myown/count_TE_gene/count_num_in_annotation_gene_TE_intergenic_v0.2.pl";
die unless (-e $script);
...
if(!$debug){
	...
	print OUT join("\t", ("sample", "total", "TE", "gene","intergenic", "pseudogene", "other", "TE+protein","TE+inter", "all_intergenic_number"  )), "\n";
	close OUT;
}
