...
#	print join("\t", ("sample", "TE", "gene","intergenic", "pseudogene", "other", "protein+TE","TE+inter", "all_intergenic_number"  )), "\n";
...
print join("\t", ( $label, $total,  $TE, $gene, $intergenic, $pseudogene, $other, $te_pro_num, $te_inter_num, $all_inter)), "\n";
