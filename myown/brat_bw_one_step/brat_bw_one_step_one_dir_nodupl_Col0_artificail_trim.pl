...
my $trim_script = "/Users/tang58/Kai_BS/myown/brat_bw_one_step/trim_for_brat_bw_STDIN_STDOUT.pl";
die unless ( -e $trim_script);
...
my $trim_cmd1 = "zcat $gz1 |  $trim_script > $in_P1";
print STDERR $trim_cmd1,"\n\n";
if(!$debug){
	`$trim_cmd1`;
}

my $trim_cmd2 = "zcat $gz2 |  $trim_script > $in_P2";
print STDERR $trim_cmd2,"\n\n";
if(!$debug){
	`$trim_cmd2`;
}
